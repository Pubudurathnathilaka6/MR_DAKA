...
const { default: fatch } = import('node-fetch');
...
async function connectToWA() {
  ...
  console.log("Connecting 🥷DAKA_XMD👑");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("🥷DAKA_XMD👑 installed successful ✅");
      console.log("🥷DAKA_XMD👑 connected to whatsapp ✅");

      let up = `🥷DAKA_XMD👑 connected successful ✅`;
      let up1 = `Hello DAKA XMD, I made bot successful`;
      ...
      robin.sendMessage("94781328353@s.whatsapp.net", {
        image: {
          url: `https://drive.google.com/file/d/11IWXN7FjbpwxYBBQyR2F9AOoz6REtxgh/view?usp=drivesdk`,
        },
        caption: up1,
  ...
  robin.ev.on("messages.upsert", async (mek) => {
    ...
    if (
      ...
      await dakaxmd.readMessages([mek.key]);
    }
    ...
    //owner react
    if (senderNumber.includes("94781328353")) {
      if (isReact) return;
      m.react("🔥")
    }
    //work type
